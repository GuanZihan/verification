...
static  int string_to_parametertype_value(const std::string &  _8434);
static  int string_to_iparam_value(const std::string &  _8435);
static  int string_to_solveform_value(const std::string &  _8436);
static  int string_to_intpnthotstart_value(const std::string &  _8437);
static  int string_to_rescode_value(const std::string &  _8438);
static  int string_to_symmattype_value(const std::string &  _8439);
static  int string_to_sensitivitytype_value(const std::string &  _8440);
static  int string_to_miocontsoltype_value(const std::string &  _8441);
static  int string_to_prosta_value(const std::string &  _8442);
static  int string_to_variabletype_value(const std::string &  _8443);
static  int string_to_startpointtype_value(const std::string &  _8444);
static  int string_to_simdupvec_value(const std::string &  _8445);
static  int string_to_optimizertype_value(const std::string &  _8446);
static  int string_to_nametype_value(const std::string &  _8447);
static  int string_to_language_value(const std::string &  _8448);
static  int string_to_internal_liinf_value(const std::string &  _8449);
static  int string_to_branchdir_value(const std::string &  _8450);
static  int string_to_xmlwriteroutputtype_value(const std::string &  _8451);
static  int string_to_purify_value(const std::string &  _8452);
static  int string_to_mark_value(const std::string &  _8453);
static  int string_to_miomode_value(const std::string &  _8454);
static  int string_to_soltype_value(const std::string &  _8455);
static  int string_to_presolvemode_value(const std::string &  _8456);
static  int string_to_compresstype_value(const std::string &  _8457);
static  int string_to_callbackcode_value(const std::string &  _8458);
static  int string_to_conetype_value(const std::string &  _8459);
static  int string_to_solitem_value(const std::string &  _8460);
static  int string_to_simhotstart_value(const std::string &  _8461);
static  int string_to_uplo_value(const std::string &  _8462);
static  int string_to_transpose_value(const std::string &  _8463);
static  int string_to_simseltype_value(const std::string &  _8464);
static  int string_to_objsense_value(const std::string &  _8465);
static  int string_to_dinfitem_value(const std::string &  _8466);
static  int string_to_solsta_value(const std::string &  _8467);
static  int string_to_scopr_value(const std::string &  _8468);
static  int string_to_internal_iinf_value(const std::string &  _8469);
static  int string_to_stakey_value(const std::string &  _8470);
static  int string_to_value_value(const std::string &  _8471);
static  int string_to_dataformat_value(const std::string &  _8472);
static  int string_to_rescodetype_value(const std::string &  _8473);
static  int string_to_boundkey_value(const std::string &  _8474);
static  int string_to_basindtype_value(const std::string &  _8475);
static  int string_to_dparam_value(const std::string &  _8476);
static  int string_to_onoffkey_value(const std::string &  _8477);
static  int string_to_feature_value(const std::string &  _8478);
static  int string_to_checkconvexitytype_value(const std::string &  _8479);
static  int string_to_orderingtype_value(const std::string &  _8480);
static  int string_to_simdegen_value(const std::string &  _8481);
static  int string_to_internal_dinf_value(const std::string &  _8482);
static  int string_to_scalingtype_value(const std::string &  _8483);
static  int string_to_simreform_value(const std::string &  _8484);
static  int string_to_scalingmethod_value(const std::string &  _8485);
static  int string_to_problemtype_value(const std::string &  _8486);
static  int string_to_iomode_value(const std::string &  _8487);
static  int string_to_mpsformat_value(const std::string &  _8488);
static  int string_to_iinfitem_value(const std::string &  _8489);
static  int string_to_problemitem_value(const std::string &  _8490);
static  int string_to_mionodeseltype_value(const std::string &  _8491);
static  int string_to_inftype_value(const std::string &  _8492);
static  int string_to_liinfitem_value(const std::string &  _8493);
static  int string_to_streamtype_value(const std::string &  _8494);
static  int string_to_sparam_value(const std::string &  _8495);
}; // struct Parameters;
